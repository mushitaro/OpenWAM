...
P6/12/18/24/30/36: Runner_Lower_{1-6} (φ52, 25mm)
    ...
    ├→ P7/13/19/25/31/37: Port_In_{1-6}_1 (φ52, 105mm) → [Valve vid=i*2+1]
    └→ P8/14/20/26/32/38: Port_In_{1-6}_2 (φ52, 105mm) → [Valve vid=i*2+2]
```
...
| 7 | Port_In_1_1 | 105 | 52.0 | 52.0 | 400 | 0.050 | 10 | 7 | 8 |
| 8 | Port_In_1_2 | 105 | 52.0 | 52.0 | 400 | 0.050 | 10 | 7 | 9 |
...
| 13 | Port_In_2_1 | 105 | 52.0 | 52.0 | 400 | 0.050 | 10 | 14 | 15 |
| 14 | Port_In_2_2 | 105 | 52.0 | 52.0 | 400 | 0.050 | 10 | 14 | 16 |
...
| 19 | Port_In_3_1 | 105 | 52.0 | 52.0 | 400 | 0.050 | 10 | 21 | 22 |
| 20 | Port_In_3_2 | 105 | 52.0 | 52.0 | 400 | 0.050 | 10 | 21 | 23 |
...
| 25 | Port_In_4_1 | 105 | 52.0 | 52.0 | 400 | 0.050 | 10 | 28 | 29 |
| 26 | Port_In_4_2 | 105 | 52.0 | 52.0 | 400 | 0.050 | 10 | 28 | 30 |
...
| 31 | Port_In_5_1 | 105 | 52.0 | 52.0 | 400 | 0.050 | 10 | 35 | 36 |
| 32 | Port_In_5_2 | 105 | 52.0 | 52.0 | 400 | 0.050 | 10 | 35 | 37 |
...
| 37 | Port_In_6_1 | 105 | 52.0 | 52.0 | 400 | 0.050 | 10 | 42 | 43 |
| 38 | Port_In_6_2 | 105 | 52.0 | 52.0 | 400 | 0.050 | 10 | 42 | 44 |
...
```
[Exhaust Valve 1] (vid=12+i*2+1) ──→ P39/42/45/48/51/54: Port_Ex_{1-6}_1 (φ48, 90mm) ──┐
                                                                                          v
[Exhaust Valve 2] (vid=12+i*2+2) ──→ P40/43/46/49/52/55: Port_Ex_{1-6}_2 (φ48, 90mm) → [Type 12 ③]
                                                                                          |
...
| Pipe ID | ラベル | 長さ(mm) | 入口径(mm) | 出口径(mm) | T(K) | 摩擦 | dx(mm) | 左CID | 右CID |
|--------:|--------|--------:|----------:|----------:|-----:|-----:|------:|------:|------:|
| 39 | Port_Ex_1_1 | 90 | 48.0 | 48.0 | 400 | 0.050 | 10 | 48 | 47 |
| 40 | Port_Ex_1_2 | 90 | 48.0 | 48.0 | 400 | 0.050 | 10 | 49 | 47 |
| 41 | Header_1 | 300 | 48.0 | 68.0 | 400 | 0.020 | 35 | 47 | 45 |

#### 気筒2 排気（Pipe 42–44）

| Pipe ID | ラベル | 長さ(mm) | 入口径(mm) | 出口径(mm) | T(K) | 摩擦 | dx(mm) | 左CID | 右CID |
|--------:|--------|--------:|----------:|----------:|-----:|-----:|------:|------:|------:|
| 42 | Port_Ex_2_1 | 90 | 48.0 | 48.0 | 400 | 0.050 | 10 | 51 | 50 |
| 43 | Port_Ex_2_2 | 90 | 48.0 | 48.0 | 400 | 0.050 | 10 | 52 | 50 |
| 44 | Header_2 | 300 | 48.0 | 68.0 | 400 | 0.020 | 35 | 50 | 45 |

#### 気筒3 排気（Pipe 45–47）

| Pipe ID | ラベル | 長さ(mm) | 入口径(mm) | 出口径(mm) | T(K) | 摩擦 | dx(mm) | 左CID | 右CID |
|--------:|--------|--------:|----------:|----------:|-----:|-----:|------:|------:|------:|
| 45 | Port_Ex_3_1 | 90 | 48.0 | 48.0 | 400 | 0.050 | 10 | 54 | 53 |
| 46 | Port_Ex_3_2 | 90 | 48.0 | 48.0 | 400 | 0.050 | 10 | 55 | 53 |
| 47 | Header_3 | 300 | 48.0 | 68.0 | 400 | 0.020 | 35 | 53 | 45 |

#### 気筒4 排気（Pipe 48–50）

| Pipe ID | ラベル | 長さ(mm) | 入口径(mm) | 出口径(mm) | T(K) | 摩擦 | dx(mm) | 左CID | 右CID |
|--------:|--------|--------:|----------:|----------:|-----:|-----:|------:|------:|------:|
| 48 | Port_Ex_4_1 | 90 | 48.0 | 48.0 | 400 | 0.050 | 10 | 57 | 56 |
| 49 | Port_Ex_4_2 | 90 | 48.0 | 48.0 | 400 | 0.050 | 10 | 58 | 56 |
| 50 | Header_4 | 300 | 48.0 | 68.0 | 400 | 0.020 | 35 | 56 | 46 |

#### 気筒5 排気（Pipe 51–53）

| Pipe ID | ラベル | 長さ(mm) | 入口径(mm) | 出口径(mm) | T(K) | 摩擦 | dx(mm) | 左CID | 右CID |
|--------:|--------|--------:|----------:|----------:|-----:|-----:|------:|------:|------:|
| 51 | Port_Ex_5_1 | 90 | 48.0 | 48.0 | 400 | 0.050 | 10 | 60 | 59 |
| 52 | Port_Ex_5_2 | 90 | 48.0 | 48.0 | 400 | 0.050 | 10 | 61 | 59 |
| 53 | Header_5 | 300 | 48.0 | 68.0 | 400 | 0.020 | 35 | 59 | 46 |

#### 気筒6 排気（Pipe 54–56）

| Pipe ID | ラベル | 長さ(mm) | 入口径(mm) | 出口径(mm) | T(K) | 摩擦 | dx(mm) | 左CID | 右CID |
|--------:|--------|--------:|----------:|----------:|-----:|-----:|------:|------:|------:|
| 54 | Port_Ex_6_1 | 90 | 48.0 | 48.0 | 400 | 0.050 | 10 | 63 | 62 |
| 55 | Port_Ex_6_2 | 90 | 48.0 | 48.0 | 400 | 0.050 | 10 | 64 | 62 |
| 56 | Header_6 | 300 | 48.0 | 68.0 | 400 | 0.020 | 35 | 62 | 46 |

#### 排気下流共通パイプ（Pipe 57–75, 19本）

| Pipe ID | ラベル | 長さ(mm) | 入口径(mm) | 出口径(mm) | T(K) | 摩擦 | dx(mm) | 左CID | 右CID | 備考 |
|--------:|--------|--------:|----------:|----------:|-----:|-----:|------:|------:|------:|------|
| 57 | Col_Out_L | 500 | 60.0 | 60.0 | 400 | 0.010 | 50 | 45 | 65 | Type12→Type6 |
| 58 | Col_Out_R | 500 | 60.0 | 60.0 | 400 | 0.010 | 50 | 46 | 66 | Type12→Type6 |
...
| 吸気ポート | φ52, 105mm | S54 CSL Spec |
| 排気ポート | φ48, 90mm | S54 CSL Spec |
| ヘッダー | φ48→φ68, 300mm | 3-into-1 ×2 |
| Col_Out | φ60, 500mm | コレクター出口 |
