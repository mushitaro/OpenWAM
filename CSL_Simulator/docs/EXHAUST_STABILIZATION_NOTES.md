...
**GREEN 47 / amber 27 / RED 26**(初回 42/25/33)。2100/100 +349→**+0**、1300/100 +10→+2、4600/65 発散→**0.00**、2100/65 0.82→0.04、870 列の分母が valid 化。残 RED の内訳: (a) 構造的 WOT 欠損 600/870/1600/1800/3100/3900、(b) **部分負荷 FLAG セル(走行帯 1100-2900 の load-30 行中心 + 1800/65・2200/65・7300/65)= surface のアイドル帯未フィット領域**。→ (b) の base 掃引 38 セル実行中、結果追記。
