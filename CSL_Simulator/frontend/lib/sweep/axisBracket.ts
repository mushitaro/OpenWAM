 ...
 *
 * Copied verbatim from E46M3CSL_TuningTool src/lib/log-engine/axisBracket.ts
 * (the tuner is a separate project and is not modified by this repo). Kept
 * byte-identical on purpose: it is the kind of primitive that grows a second,
 * subtly different copy the moment someone edits one of them.
 *
 * ## Why this exists
 *
