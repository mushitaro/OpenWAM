...
void TTable::LeeController(const std::string &FileWAM, fpos_t &filepos) {
...
void TTable::LeeResultadosMedControlador(const std::string &FileWAM,
                                         fpos_t &filepos) {
  try {
    int nvars = 0, var = 0;
...
void TTable::LeeResultadosInsControlador(const std::string &FileWAM,
                                         fpos_t &filepos) {
  try {
    int nvars = 0, var = 0;
