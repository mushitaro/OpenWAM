...
double TTable::Output(double Time) { return fOutput; }

void TTable::LeeController(std::istream &FileInput) {
...
void TTable::LeeResultadosMedControlador(std::istream &FileInput) {
  try {
    int nvars = 0, var = 0;
    FileInput >> nvars;
...
void TTable::LeeResultadosInsControlador(std::istream &FileInput) {
  try {
    int nvars = 0, var = 0;
    FileInput >> nvars;
    for (int i = 0; i < nvars; i++) {
...
void TTable::CabeceraResultadosMedControlador(std::ostream &medoutput) {
  try {
    std::string Label;
...
void TTable::CabeceraResultadosInsControlador(std::ostream &insoutput) {
  try {
    std::string Label;
...
void TTable::ImprimeResultadosMedControlador(std::ostream &medoutput) {
  try {
    std::string Label;
...
void TTable::ImprimeResultadosInsControlador(std::ostream &insoutput) {
  try {
    std::string Label;
...
void TTable::ResultadosMediosController() {
  try {
    ...
    if (FResMediosCtrl.Error) {
      FResMediosCtrl.ErrorMED =
          FResMediosCtrl.ErrorSUM / FResMediosCtrl.TiempoSUM;
      FResMediosCtrl.ErrorSUM = 0.;
    }
    if (FResMediosCtrl.POutput) {
      FResMediosCtrl.POutputMED =
          FResMediosCtrl.POutputSUM / FResMediosCtrl.TiempoSUM;
      FResMediosCtrl.POutputSUM = 0.;
    }
    if (FResMediosCtrl.IOutput) {
      FResMediosCtrl.IOutputMED =
          FResMediosCtrl.IOutputSUM / FResMediosCtrl.TiempoSUM;
      FResMediosCtrl.IOutputSUM = 0.;
    }
    if (FResMediosCtrl.DOutput) {
      FResMediosCtrl.DOutputMED =
          FResMediosCtrl.DOutputSUM / FResMediosCtrl.TiempoSUM;
      FResMediosCtrl.DOutputSUM = 0.;
    }
    if (FResMediosCtrl.Output_filt) {
      FResMediosCtrl.Output_filtMED =
          FResMediosCtrl.Output_filtSUM / FResMediosCtrl.TiempoSUM;
      FResMediosCtrl.Output_filtSUM = 0.;
    }
    FResMediosCtrl.TiempoSUM = 0;
...
void TTable::AcumulaResultadosMediosController(double Actual) {
   ...
   */
    ...
    if (FResMediosCtrl.Error) {
      FResMediosCtrl.ErrorSUM += 0.0 * Delta;
    }
    if (FResMediosCtrl.POutput) {
      FResMediosCtrl.POutputSUM += 0.0 * Delta;
    }
    if (FResMediosCtrl.IOutput) {
      FResMediosCtrl.IOutputSUM += 0.0 * Delta;
    }
    if (FResMediosCtrl.DOutput) {
      FResMediosCtrl.DOutputSUM += 0.0 * Delta;
    }
    if (FResMediosCtrl.Output_filt) {
      FResMediosCtrl.Output_filtSUM += 0.0 * Delta;
    }
...
void TTable::ResultadosInstantController() {
  try {
    ...
    if (FResInstantCtrl.Error)
      FResInstantCtrl.ErrorINS = 0.0;
    if (FResInstantCtrl.POutput)
      FResInstantCtrl.POutputINS = 0.0;
    if (FResInstantCtrl.IOutput)
      FResInstantCtrl.IOutputINS = 0.0;
    if (FResInstantCtrl.DOutput)
      FResInstantCtrl.DOutputINS = 0.0;
    if (FResInstantCtrl.Output_filt)
      FResInstantCtrl.Output_filtINS = 0.0;
