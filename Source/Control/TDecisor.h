...
/*! This object represents a decisor. The decirsor chooses the output of one
 controller (high) or other depending on the fact that the valued sensed is
 higher or lower than the target value */
class TDecisor : public TController {
private:
  int fControllerLowID;  //!< This parameter represents the controller ID of the
                         //!< lower controller
  int fControllerHighID; //!< This parameter represents the controller ID of the
                         //!< higher controller
  ...
  TController *
      fControllerTarget; //!< This controller is used to decide the target value
...
public:
  ...
  void
  LeeController(const std::string &FileWAM, //!< File name of the input data
  ...
  void LeeResultadosMedControlador(
      const std::string &FileWAM, //!< File name of the input data
      fpos_t &filepos             //!< Position within the file to read
  );
