...
void TPIDController::CabeceraResultadosMedControlador(std::ostream &medoutput) {
  try {
    std::string Label;
...
void TPIDController::CabeceraResultadosInsControlador(std::ostream &insoutput) {
  try {
    std::string Label;
...
void TPIDController::ImprimeResultadosMedControlador(std::ostream &medoutput) {
  try {
    std::string Label;
...
void TPIDController::ImprimeResultadosInsControlador(std::ostream &insoutput) {
  try {
    std::string Label;
