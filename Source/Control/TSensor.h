...
/*! This object is used to get information from some objects and provides it to
 * controllers */
class TSensor {
private:
  ...
  double FDistancia; //!< If the object sensed is a pipe. Distance from the left
                     //!< end where the parameter is sensed
  int FNode0;    //!< If the object sensed is a pipe. Left cell from the place
                 //!< where the parameter is sensed
  int FNode1;    //!< If the object sensed is a pipe. Right cell from the place
                 //!< where the parameter is sensed
  ...
  stResInstantSensor
      FResInstantSensor;              //!< Struct with the instantaneus results
  stResMediosSensor FResMediosSensor; //!< Struct with the average results

  double
      FPeriod; //!< Controls the time period to update the sensor measurement.
