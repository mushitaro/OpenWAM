...
void TCompresor::InterpolaValoresMapa(double rtc) {
  try {
    ...
    throw Exception("ERROR: InterpolaValoresMapa en el compresor: " +
...
void TCompresor::AcumulaMedias(double Tiempo) {
  ...
  try {
    ...
    std::cout << "ERROR: AcumulaMedias en el compresor: " << FNumeroCompresor
              << std::endl;
    std::cout << "Tipo de error: " << N.what() << std::endl;
    throw Exception("ERROR: AcumulaMedias en el compresor: " +
                    std::to_string(FNumeroCompresor) + N.what());
  }
}
...
void TCompresor::IniciaMedias() {
  ...
  try {
    ...
    std::cout << "ERROR: IniciaMedias en el compresor: " << FNumeroCompresor
              << std::endl;
    std::cout << "Tipo de error: " << N.what() << std::endl;
    throw Exception("ERROR: IniciaMedias en el compresor: " +
                    std::to_string(FNumeroCompresor) + N.what());
  }
}
...
void TCompresor::CalculoPotenciaPaso() {
  try {
    ...
    std::cout << "ERROR: TCompresor::CalculoPotenciaPaso en el compresor: "
              << FNumeroCompresor << std::endl;
    std::cout << "Tipo de error: " << N.what() << std::endl;
    throw Exception("ERROR: TCompresor::CalculoPotenciaPaso en el compresor: " +
                    std::to_string(FNumeroCompresor) + N.what());
  }
}
//---------------------------------------------------------------------------
...
void TCompresor::CalculaMedias() {
  ...
  try {
    FMedias.RelacionCompresion =
        FMedias.RelacionCompresionSUM / FMedias.TiempoSUM;
    ...
    std::cout << "ERROR: CalculaMedias en el compresor: " << FNumeroCompresor
              << std::endl;
    std::cout << "Tipo de error: " << N.what() << std::endl;
    throw Exception("ERROR: CalculaMedias en el compresor: " +
                    std::to_string(FNumeroCompresor) + N.what());
  }
}
...
void TCompresor::CalculaInstantaneos() {
  try {
    ...
    std::cout << "ERROR: CalculaInstantaneos en el compresor: "
              << FNumeroCompresor << std::endl;
    std::cout << "Tipo de error: " << N.what() << std::endl;
    throw Exception("ERROR: CalculaInstantaneos en el compresor: " +
                    std::to_string(FNumeroCompresor) + N.what());
  }
}
...
void TCompresor::LeeDatosGraficasMedias(const std::string &FileWAM,
  ...
  try {
    ...
    std::cout << "ERROR: LeeDatosGraficasMedias en el compresor: "
              << FNumeroCompresor << std::endl;
    std::cout << "Tipo de error: " << N.what() << std::endl;
    throw Exception("ERROR: LeeDatosGraficasMedias en el compresor: " +
                    std::to_string(FNumeroCompresor) + N.what());
  }
}
...
void TCompresor::CabeceraGraficasMedias(stringstream &medoutput) {
  try {
    ...
    std::cout << "ERROR: CabeceraGraficasMedias en el compresor: "
              << FNumeroCompresor << std::endl;
    std::cout << "Tipo de error: " << N.what() << std::endl;
    throw Exception("ERROR: CabeceraGraficasMedias en el compresor: " +
                    std::to_string(FNumeroCompresor) + N.what());
  }
}
...
void TCompresor::ImprimeGraficasMedias(stringstream &medoutput) {
  try {
    ...
    std::cout << "ERROR: ImprimeGraficasMedias en el compresor: "
              << FNumeroCompresor << std::endl;
    std::cout << "Tipo de error: " << N.what() << std::endl;
    throw Exception("ERROR: ImprimeGraficasMedias en el compresor: " +
                    std::to_string(FNumeroCompresor) + N.what());
  }
}
...
void TCompresor::CabeceraGraficasInstantaneas(stringstream &insoutput) {
  try {
    ...
    std::cout << "ERROR: CabeceraGraficasInstantaneas en el compresor: "
              << FNumeroCompresor << std::endl;
    std::cout << "Tipo de error: " << N.what() << std::endl;
    throw Exception("ERROR: CabeceraGraficasInstantaneas en el compresor: " +
                    std::to_string(FNumeroCompresor) + N.what());
  }
}
...
void TCompresor::ImprimeGraficasInstantaneas(stringstream &insoutput) {
  try {
    ...
    std::cout << "ERROR: ImprimeGraficasInstantaneas en el compresor: "
              << FNumeroCompresor << std::endl;
    std::cout << "Tipo de error: " << N.what() << std::endl;
    throw Exception("ERROR: ImprimeGraficasInstantaneas en el compresor: " +
                    std::to_string(FNumeroCompresor) + N.what());
  }
}
...
void TCompresor::AsignAcousticElements(
  ...
  if (FIsAcoustic) {
    ...
    std::vector<TDeposito *> RawVolume;
    RawVolume.reserve(Volume.size());
    for (const auto &v : Volume)
      RawVolume.push_back(v.get());

    FAcComp->AsignInPipe(RawPipe.data());
    FAcComp->AsignOutPipe(RawPipe.data());
    FAcComp->AsignVolute(RawPipe.data());
    FAcComp->AsignRotorVol(RawVolume.data());
    FAcComp->AsignStatorVol(RawVolume.data());
  }
}
