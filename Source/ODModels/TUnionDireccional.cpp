...
void TUnionDireccional::CalculoUnionDireccional() {
  try {
    ...
    /* Parametro independiente y pendiente de la recta para el calculo del
     * Coeficiende de Descarga */
